...
const linkVariants = tv({
  base: 'relative inline-flex items-center justify-center whitespace-nowrap select-none text-primary ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
  variants: {
    variant: {
      button:
