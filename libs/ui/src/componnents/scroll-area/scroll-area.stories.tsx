...
const Component = (props: React.ComponentProps<typeof ScrollArea>) => (
  <ScrollArea {...props} className="h-[200px] w-[350px] rounded-md border p-4">
...
const Story: Meta<typeof ScrollArea> = {
  component: Component,
